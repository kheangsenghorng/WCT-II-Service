...
const ConfirmBooking = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6  rounded-lg ">
      <h1 className="text-2xl font-semibold  mb-8 text-green-600">Confirm Booking</h1>
          ...
          {paymentMethod === 'card' && (
            <>
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex gap-1">
                    ...
                    <div className="w-6 h-4 bg-orange-500 rounded text-white text-xs flex items-center justify-center font-bold">D</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <label htmlFor="cvv" className="block text-sm font-medium text-gray-700 mb-1">
                    CVC/CVC <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    id="cvv"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="lastNameBilling" className="block text-sm font-medium text-gray-700 mb-1">
                    Last name
                  </label>
                  <input
                    type="text"
